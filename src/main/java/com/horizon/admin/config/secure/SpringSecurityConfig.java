package com.horizon.admin.config.secure;
...
import com.horizon.service.UserContextService;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	@Inject UserContextService authService;
    ...
    protected void configure(HttpSecurity security) throws Exception
    {
        security
                .authorizeRequests()
                	.antMatchers("/user/**", "/merchant/**", "/admin/**").hasRole("USER")
